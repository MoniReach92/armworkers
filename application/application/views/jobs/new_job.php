...
<div class="box box-solid bg-dark">
  <div class="box-header with-border">
    ...
    <h3 class="box-title text-yellow"><span class="khmer_font">លប់ប្រភេទការងារ </span> &#921; Delete Job Type</h3>
		...
		<div class="row">
			...
			<div class="col-6">
				<div class="form-group row">
				  <label for="name" class="col-sm-2 col-form-label text-right"><span class="khmer_font">ឈ្មោះការងារ<br/></span>Job Name<span class="text-danger">&#9734;</span></label>
                  <?php if(!isset($job['name'])) { $job['name'] = NULL ; } ?>
				  <div class="col-sm-10">
					<input class="form-control" type="text" name="name" placeholder="Job Name" value="<?php echo $job['name'] ?>">
				  </div>
				</div>
				<div class="form-group row">
					<label for="description" class="col-sm-2 col-form-label text-right"><span class="khmer_font">ពិពណ៌នាអំពីការងារ<br/></span>Job Description</label>
					<?php if(!isset($job['description'])) { $job['description'] = NULL ; } ?>
					<div class="col-sm-10">
						<textarea name="description" id="textarea" class="form-control" placeholder="Please add some description."><?php echo $job['description'] ?></textarea>
					</div>
				</div>
					<div class="form-group row">
				<?php if($call_method == 'show') { ?>
				<a href="<?php echo site_url('Jobs/edit/' . $job['id']); ?>" class="btn btn-block btn-info btn-lg">Edit This Record</a>
